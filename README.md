...
```console
> nix run github:kachick/selfup/v1.1.5 -- --version
selfup dev (rev)
```
...
> curl -L https://github.com/kachick/selfup/releases/download/v1.1.5/selfup_Linux_x86_64.tar.gz | tar xvz -C "$install_path" selfup
